...
myStartupHook = do
  ...
  spawn ("sleep 2 && trayer --edge top --widthtype request --padding 0 --SetDockType true --SetPartialStrut false --expand true --monitor 1 --transparent true --alpha 0 " ++ colorTrayer ++ " --height 0")

  -- spawnOnce "xargs xwallpaper --stretch < ~/.cache/wall"
  spawnOnce "~/.fehbg &"  -- set last saved feh wallpaper
  -- spawnOnce "feh --randomize --bg-fill ~/Pictures/Wallpapers/backgrounds/*"  -- feh set random wallpaper
...
-- myWorkspaces = [" www ", " dev ", " tg ", " ds ", " file ", " sys ", " etc "]
myWorkspaces = ["\984479", "\59298", "\57879", "\984687", "\61564", "\61459", "\986004" ]
-- myWorkspaces =
--         " 1 : <fn=2>\xf111</fn> " :
--         " 2 : <fn=2>\xf1db</fn> " :
--         " 3 : <fn=2>\xf192</fn> " :
...
myManageHook = composeAll
  ...
  , title =? "Opera"   --> doShift ( myWorkspaces !! 0 )
...
myKeys c =
  ...
  , ("M-M1-f", addName "Launch web browser"       $ spawn (myBrowser))
  ...
  [ ("M-r", addName "Toggle float layout"        $ sendMessage (T.Toggle "floats"))
...
main = do
 ...
 --        --               ("<box type=Bottom width=2 mb=2 color=" ++ color06 ++ ">") "</box>"
	-- , ppCurrent = xmobarColor color12 "" . wrap "[" "]" . clickable
 --          -- Visible but not current workspace
 --    , ppVisible = xmobarColor color06 "" . clickable
 --          -- Hidden workspace
 --        -- , ppHidden = xmobarColor color05 "" . wrap
 --        --              ("<box type=Top width=2 mt=2 color=" ++ color05 ++ ">") "</box>" . clickable
	-- , ppHidden = xmobarColor color03 "" . wrap "" "" . clickable
